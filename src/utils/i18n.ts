...
const vi = {
  ...
  'settings.decimal_places': 'Chữ số thập phân (.00)',
  'settings.decimal_show': 'Hiện (100.00)',
  'settings.decimal_hide': 'Ẩn (100)',
...
const en = {
  ...
  'settings.decimal_places': 'Decimal Places (.00)',
  'settings.decimal_show': 'Show (100.00)',
  'settings.decimal_hide': 'Hide (100)',
